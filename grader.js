...
var URLPATH_DEFAULT = "http://www.google.com";
...
var cheerioHtmlUrl = function(urladdress, checks) {
	...
	if (result instanceof Error){
	    ...
	    fs.writeFileSync("hw3.json",outJson);
	    console.log(outJson);
	}
...
if(require.main == module) {
	...
	.option('-u, --url <urladdress>', 'url desired')
	.parse(process.argv);
